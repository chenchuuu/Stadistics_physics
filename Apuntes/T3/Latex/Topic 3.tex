...
\begin{document}
	...
	We can define $\eta_{\Delta\mathbf{q}\Delta\mathbf{p}}$ as the number of microstates in the ensemble that fall within the volume $\Delta\mathbf{q}\Delta\mathbf{p}$. As $\eta$ approaches infinity, the cloud of points transforms into a continuous medium in phase space. The density of this continuous medium is precisely the density function:
