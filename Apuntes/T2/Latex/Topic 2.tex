...
\begin{document}
	...
	\begin{enumerate}
		\item An isotropic atom has no rotational degrees of freedom , but only three translational degrees of freedom. " Reason of no rotational degrees of freedom".
		\item An anisotropic atom of two side, one likes water and one likes oil has 2 rotational degrees of freedom and the three translational degrees of freedom.
	...
	\begin{equation}
		microstate \equiv \left\{\mathbf{q}, \mathbf{p}\right\}
	\end{equation}
